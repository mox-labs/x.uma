  ...
  fromJSON(object: any): Expr {
    return {
      ...
      comprehensionExpr: isSet(object.comprehensionExpr)
        ...
        ? Expr_Comprehension.fromJSON(object.comprehension_expr)
        : undefined,
    };
  },
...
export const Expr_Select: MessageFns<Expr_Select> = {
  ...
  fromJSON(object: any): Expr_Select {
    return {
      ...
      testOnly: isSet(object.testOnly)
        ? globalThis.Boolean(object.testOnly)
        : isSet(object.test_only)
        ? globalThis.Boolean(object.test_only)
        : false,
    };
  },
  ...
  fromJSON(object: any): Expr_CreateList {
    return {
      ...
      optionalIndices: globalThis.Array.isArray(object?.optionalIndices)
        ...
        : globalThis.Array.isArray(object?.optional_indices)
        ? object.optional_indices.map((e: any) => globalThis.Number(e))
        : [],
    };
  },
...
export const Expr_CreateStruct_Entry: MessageFns<Expr_CreateStruct_Entry> = {
  ...
  fromJSON(object: any): Expr_CreateStruct_Entry {
    return {
      id: isSet(object.id) ? globalThis.Number(object.id) : 0,
      fieldKey: isSet(object.fieldKey)
        ? globalThis.String(object.fieldKey)
        : isSet(object.field_key)
        ? globalThis.String(object.field_key)
        : undefined,
      mapKey: isSet(object.mapKey)
        ? Expr.fromJSON(object.mapKey)
        : isSet(object.map_key)
        ? Expr.fromJSON(object.map_key)
        : undefined,
      value: isSet(object.value) ? Expr.fromJSON(object.value) : undefined,
      optionalEntry: isSet(object.optionalEntry)
        ? globalThis.Boolean(object.optionalEntry)
        : isSet(object.optional_entry)
        ? globalThis.Boolean(object.optional_entry)
        : false,
    };
  },
...
export const Expr_Comprehension: MessageFns<Expr_Comprehension> = {
  ...
  fromJSON(object: any): Expr_Comprehension {
    return {
      iterVar: isSet(object.iterVar)
        ? globalThis.String(object.iterVar)
        : isSet(object.iter_var)
        ? globalThis.String(object.iter_var)
        : "",
      iterVar2: isSet(object.iterVar2)
        ? globalThis.String(object.iterVar2)
        : isSet(object.iter_var2)
        ? globalThis.String(object.iter_var2)
        : "",
      iterRange: isSet(object.iterRange)
        ? Expr.fromJSON(object.iterRange)
        : isSet(object.iter_range)
        ? Expr.fromJSON(object.iter_range)
        : undefined,
      accuVar: isSet(object.accuVar)
        ? globalThis.String(object.accuVar)
        : isSet(object.accu_var)
        ? globalThis.String(object.accu_var)
        : "",
      accuInit: isSet(object.accuInit)
        ? Expr.fromJSON(object.accuInit)
        : isSet(object.accu_init)
        ? Expr.fromJSON(object.accu_init)
        : undefined,
      loopCondition: isSet(object.loopCondition)
        ? Expr.fromJSON(object.loopCondition)
        : isSet(object.loop_condition)
        ? Expr.fromJSON(object.loop_condition)
        : undefined,
      loopStep: isSet(object.loopStep)
        ? Expr.fromJSON(object.loopStep)
        : isSet(object.loop_step)
        ? Expr.fromJSON(object.loop_step)
        : undefined,
...
function createBaseSourceInfo(): SourceInfo {
  return { syntaxVersion: "", location: "", lineOffsets: [], positions: {}, macroCalls: {}, extensions: [] };
}
...
export const SourceInfo: MessageFns<SourceInfo> = {
  encode(message: SourceInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    writer.join();
    globalThis.Object.entries(message.positions).forEach(([key, value]: [string, number]) => {
      SourceInfo_PositionsEntry.encode({ key: key as any, value }, writer.uint32(34).fork()).join();
    });
    globalThis.Object.entries(message.macroCalls).forEach(([key, value]: [string, Expr]) => {
  ...
  fromJSON(object: any): SourceInfo {
    return {
      ...
      lineOffsets: globalThis.Array.isArray(object?.lineOffsets)
        ...
        : globalThis.Array.isArray(object?.line_offsets)
      ...
      macroCalls: isObject(object.macroCalls)
        ? (globalThis.Object.entries(object.macroCalls) as [string, any][]).reduce(
          (acc: { [key: number]: Expr }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = Expr.fromJSON(value);
            return acc;
          },
          {},
        )
        : isObject(object.macro_calls)
        ? (globalThis.Object.entries(object.macro_calls) as [string, any][]).reduce(
          (acc: { [key: number]: Expr }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = Expr.fromJSON(value);
            return acc;
          },
  ...
  toJSON(message: SourceInfo): unknown {
    ...
    if (message.positions) {
      const entries = globalThis.Object.entries(message.positions) as [string, number][];
      if (entries.length > 0) {
        obj.positions = {};
        entries.forEach(([k, v]) => {
    ...
    if (message.macroCalls) {
      const entries = globalThis.Object.entries(message.macroCalls) as [string, Expr][];
      if (entries.length > 0) {
        obj.macroCalls = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<SourceInfo>): SourceInfo {
    ...
    message.positions = (globalThis.Object.entries(object.positions ?? {}) as [string, number][]).reduce(
    ...
    message.macroCalls = (globalThis.Object.entries(object.macroCalls ?? {}) as [string, Expr][]).reduce(
      (acc: { [key: number]: Expr }, [key, value]: [string, Expr]) => {
        if (value !== undefined) {
          acc[globalThis.Number(key)] = Expr.fromPartial(value);
        }
        return acc;
      },
      {},
  ...
  fromJSON(object: any): SourceInfo_Extension {
    return {
      ...
      affectedComponents: globalThis.Array.isArray(object?.affectedComponents)
        ...
        : globalThis.Array.isArray(object?.affected_components)
        ? object.affected_components.map((e: any) => sourceInfo_Extension_ComponentFromJSON(e))
        : [],
