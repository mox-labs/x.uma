...
export const CheckedExpr: MessageFns<CheckedExpr> = {
  encode(message: CheckedExpr, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.referenceMap).forEach(([key, value]: [string, Reference]) => {
      CheckedExpr_ReferenceMapEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).join();
    });
    globalThis.Object.entries(message.typeMap).forEach(([key, value]: [string, Type]) => {
  ...
  fromJSON(object: any): CheckedExpr {
    return {
      referenceMap: isObject(object.referenceMap)
        ? (globalThis.Object.entries(object.referenceMap) as [string, any][]).reduce(
          (acc: { [key: number]: Reference }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = Reference.fromJSON(value);
            return acc;
          },
          {},
        )
        : isObject(object.reference_map)
        ? (globalThis.Object.entries(object.reference_map) as [string, any][]).reduce(
          (acc: { [key: number]: Reference }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = Reference.fromJSON(value);
            return acc;
          },
      ...
      typeMap: isObject(object.typeMap)
        ? (globalThis.Object.entries(object.typeMap) as [string, any][]).reduce(
          (acc: { [key: number]: Type }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = Type.fromJSON(value);
            return acc;
          },
          {},
        )
        : isObject(object.type_map)
        ? (globalThis.Object.entries(object.type_map) as [string, any][]).reduce(
          (acc: { [key: number]: Type }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = Type.fromJSON(value);
            return acc;
          },
      ...
      sourceInfo: isSet(object.sourceInfo)
        ...
        : isSet(object.source_info)
        ? SourceInfo.fromJSON(object.source_info)
        : undefined,
      exprVersion: isSet(object.exprVersion)
        ? globalThis.String(object.exprVersion)
        : isSet(object.expr_version)
        ? globalThis.String(object.expr_version)
        : "",
  ...
  toJSON(message: CheckedExpr): unknown {
    ...
    if (message.referenceMap) {
      const entries = globalThis.Object.entries(message.referenceMap) as [string, Reference][];
      if (entries.length > 0) {
        obj.referenceMap = {};
        entries.forEach(([k, v]) => {
    ...
    if (message.typeMap) {
      const entries = globalThis.Object.entries(message.typeMap) as [string, Type][];
      if (entries.length > 0) {
        obj.typeMap = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<CheckedExpr>): CheckedExpr {
    const message = createBaseCheckedExpr();
    message.referenceMap = (globalThis.Object.entries(object.referenceMap ?? {}) as [string, Reference][]).reduce(
      (acc: { [key: number]: Reference }, [key, value]: [string, Reference]) => {
        if (value !== undefined) {
          acc[globalThis.Number(key)] = Reference.fromPartial(value);
        }
        return acc;
      },
      {},
    );
    message.typeMap = (globalThis.Object.entries(object.typeMap ?? {}) as [string, Type][]).reduce(
      (acc: { [key: number]: Type }, [key, value]: [string, Type]) => {
        if (value !== undefined) {
          acc[globalThis.Number(key)] = Type.fromPartial(value);
        }
        return acc;
      },
      {},
...
export const Type: MessageFns<Type> = {
  encode(message: Type, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.dyn !== undefined) {
      Empty.encode(message.dyn, writer.uint32(10).fork()).join();
    }
    ...
    if (message.listType !== undefined) {
      Type_ListType.encode(message.listType, writer.uint32(50).fork()).join();
    }
    if (message.mapType !== undefined) {
      Type_MapType.encode(message.mapType, writer.uint32(58).fork()).join();
    }
    if (message.function !== undefined) {
      Type_FunctionType.encode(message.function, writer.uint32(66).fork()).join();
    }
    ...
    if (message.type !== undefined) {
      Type.encode(message.type, writer.uint32(90).fork()).join();
    }
    if (message.error !== undefined) {
      Empty.encode(message.error, writer.uint32(98).fork()).join();
    }
    if (message.abstractType !== undefined) {
      Type_AbstractType.encode(message.abstractType, writer.uint32(114).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): Type {
    return {
      ...
      messageType: isSet(object.messageType)
        ...
        : undefined,
      typeParam: isSet(object.typeParam)
        ? globalThis.String(object.typeParam)
        : isSet(object.type_param)
        ? globalThis.String(object.type_param)
        : undefined,
      ...
      abstractType: isSet(object.abstractType)
        ...
        ? Type_AbstractType.fromJSON(object.abstract_type)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): Type_ListType {
    return {
      elemType: isSet(object.elemType)
        ...
        : isSet(object.elem_type)
        ? Type.fromJSON(object.elem_type)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): Type_FunctionType {
    return {
      resultType: isSet(object.resultType)
        ...
        ? Type.fromJSON(object.result_type)
        : undefined,
      argTypes: globalThis.Array.isArray(object?.argTypes)
        ? object.argTypes.map((e: any) => Type.fromJSON(e))
        : globalThis.Array.isArray(object?.arg_types)
  ...
  fromJSON(object: any): Type_AbstractType {
    return {
      ...
      parameterTypes: globalThis.Array.isArray(object?.parameterTypes)
        ...
        : globalThis.Array.isArray(object?.parameter_types)
...
export const Decl: MessageFns<Decl> = {
  encode(message: Decl, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.ident !== undefined) {
      Decl_IdentDecl.encode(message.ident, writer.uint32(18).fork()).join();
    }
    if (message.function !== undefined) {
      Decl_FunctionDecl.encode(message.function, writer.uint32(26).fork()).join();
    }
    return writer;
  },
...
export const Decl_FunctionDecl_Overload: MessageFns<Decl_FunctionDecl_Overload> = {
  ...
  fromJSON(object: any): Decl_FunctionDecl_Overload {
    return {
      overloadId: isSet(object.overloadId)
        ? globalThis.String(object.overloadId)
        : isSet(object.overload_id)
        ? globalThis.String(object.overload_id)
        : "",
      ...
      typeParams: globalThis.Array.isArray(object?.typeParams)
        ...
        : globalThis.Array.isArray(object?.type_params)
      ...
      isInstanceFunction: isSet(object.isInstanceFunction)
        ? globalThis.Boolean(object.isInstanceFunction)
        : isSet(object.is_instance_function)
  ...
  fromJSON(object: any): Reference {
    return {
      ...
      overloadId: globalThis.Array.isArray(object?.overloadId)
        ...
        : globalThis.Array.isArray(object?.overload_id)
