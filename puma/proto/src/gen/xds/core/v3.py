...
# sources: xds/core/v3/authority.proto, xds/core/v3/cidr.proto, xds/core/v3/context_params.proto, xds/core/v3/resource_locator.proto, xds/core/v3/collection_entry.proto, xds/core/v3/extension.proto, xds/core/v3/resource_name.proto, xds/core/v3/resource.proto
...
class CollectionEntryInlineEntry(betterproto.Message):
    ...
    resource: protobuf.Any = betterproto.message_field(3)
...
class ResourceName(betterproto.Message):
    ...
    xdstp://{authority}/{type_url}/{id}?{context_params} where context_params
    take the form of URI query parameters. A xDS resource name fully identifies
    a network resource for transport purposes. xDS resource names in this form
    appear only in discovery request/response messages used with the xDS
    transport.
    """
...
class Resource(betterproto.Message):
    ...
    name: "ResourceName" = betterproto.message_field(1)
    # The resource's logical version. It is illegal to have the same named xDS
    # resource name at a given version with different resource payloads.
    version: str = betterproto.string_field(2)
    # The resource payload, including type URL.
